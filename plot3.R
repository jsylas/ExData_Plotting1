...
# Plot the graph
png(file="plot3.png")
with(data1,plot(DateTime1,Sub_metering_1,type="n",ylab="Energy Sub meeting",xlab=""))
with(data1,lines(DateTime1,Sub_metering_1,col="black"))
with(data1,lines(DateTime1,Sub_metering_2,col="red"))
with(data1,lines(DateTime1,Sub_metering_3,col="blue"))
